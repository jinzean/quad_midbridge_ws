...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[
                governor_params,
                {
                    ...
                    'takeoff_release_vz_abs_max': 0.25,
                    'takeoff_release_vxy_abs_max': 0.30,
                    'takeoff_release_stable_time_sec': 0.5,
                    'takeoff_kp_z': 1.8,
                    'takeoff_kd_z': 2.6,
        ...
        Node(
            package='quad_midbridge_governor',
            executable='aligned_local_intent_node',
            name='aligned_local_intent_node',
            output='screen',
            parameters=[
                {
                    'reanchor_each_publish': False,
                    'enable_takeoff_z_blend': False,
                    'takeoff_z_blend_start_height_m': 1.10,
                    'takeoff_z_blend_height_m': 0.50,
                    'target_z': -1.5,
